		...
		context.stage('Checkout GitHub Repository') {
			...
			if (!fork) {
				def info = context.checkout scm: [$class: 'GitSCM', branches: [[name: branch]], \
						doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'CheckoutOption', timeout: 15], [$class: 'CloneOption', depth: 0, noTags: true, reference: '', shallow: false, timeout: 15]], \
