		...
		context.stage('Checkout GitHub Repository') {
			...
			if (!fork) {
				context.checkout scm: [$class: 'GitSCM', branches: [[name: branch]], \
						doGenerateSubmoduleConfigurations: false, extensions: [[$class: 'CheckoutOption', timeout: 15], [$class: 'CloneOption', depth: 10, noTags: true, reference: '', shallow: false, timeout: 15]], \
