...
*/
    ...
    protected void generatePipeline(XmlSuite currentSuite) {
        ...
        jobName = replaceSpecialSymbols(jobName.toString())
...
//        def supportedBrowsers = ''
//        if (!isParamEmpty(currentSuite.getParameter(JENKINS_REGRESSION_MATRIX))) {
//            supportedBrowsers = currentSuite.getParameter(JENKINS_REGRESSION_MATRIX)
//        } else {
//            supportedBrowsers = !isParamEmpty(currentSuite.getParameter("jenkinsPipelineBrowsers"))?currentSuite.getParameter("jenkinsPipelineBrowsers"):""
//        }
