...
//			TODO: analyze do we need system jobs for QA repo... maybe prametrize CreateRepository call
            ...
            if (isDevRepo) {
                registerObject("build_job", new BuildJobFactory(repoFolder, getPipelineScript(), "build-" + Configuration.get(REPO), githubHost, githubOrganization, Configuration.get(REPO), Configuration.get(BRANCH)))
            }
