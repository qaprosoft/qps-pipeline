...
class CarinaRunner {
    ...
    protected def proceedSuccessfulBuild(releaseName, subject, to) {
        ...
        def body = "<p>http://ci.qaprosoft.com/nexus/content/repositories/snapshots/com/qaprosoft/carina-core/${releaseName}/</p><br><br>This is autogenerated message.<br>Please, do not reply."
