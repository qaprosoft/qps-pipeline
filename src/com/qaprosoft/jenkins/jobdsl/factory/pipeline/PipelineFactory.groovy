...
public class PipelineFactory extends JobFactory {
    ...
    def setDefaultParams() {
        ...
        parametersMap.put("auto_screenshot", null)
        parametersMap.put("enableVideo", null)
        parametersMap.put("capabilities", null)
        parametersMap.put("job_type", null)
        parametersMap.put("capabilities.provider", "")
        parametersMap.put("node_label", "")
        parametersMap.put("branch", "master")
        parametersMap.put("repo", "")
        parametersMap.put("GITHUB_HOST", "")
        parametersMap.put("GITHUB_ORGANIZATION", "")
        parametersMap.put("sub_project", null)
        parametersMap.put("zafira_project", null)
        parametersMap.put("suite", null)
        parametersMap.put("ci_parent_url", "")
        parametersMap.put("ci_parent_build", "")
        parametersMap.put("slack_channels", null)
        parametersMap.put("ci_run_id", "")
        parametersMap.put("BuildPriority", "3")
        parametersMap.put("queue_registration", null)
        parametersMap.put("thread_count", null)
        parametersMap.put("data_provider_thread_count", null)
        parametersMap.put("email_list", "")
        parametersMap.put("failure_email_list", null)
        parametersMap.put("retry_count", null)
        parametersMap.put("rerun_failures", null)
