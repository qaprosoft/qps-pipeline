    ...
    def create() {
        ...
        pipelineJob.with {
            ...
            parameters {
                ...
                stringParam('data_provider_thread_count', currentSuite.toXml().contains("data-provider-thread-count") ? currentSuite.getThreadCount().toString() : "1", 'number of data provider threads')
